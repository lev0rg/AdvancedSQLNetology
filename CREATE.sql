...
CREATE TABLE IF NOT EXISTS Album (
	...
	album_year_release INTEGER CHECK (album_year_release >= 1970)
);
...
CREATE TABLE IF NOT EXISTS Track (
	...
	track_duration INTEGER CHECK (track_duration between 60 and 420),
...
CREATE TABLE IF NOT EXISTS Collection (
	...
	collection_year_release INTEGER CHECK (collection_year_release >= 1970)
);
